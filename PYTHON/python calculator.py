...
val=""
data=StringVar()
display=Entry(root,bd=18,bg="pink",font="arial 20", justify="right",textvariable=data)
...
btn_minus=Button(root,text="-",font="ariel 12 bold",bd=12,height=2,width=6, command=lambda:btnClick('-'))
...
btn_zero=Button(root,text="0",font="ariel 12 bold",bd=12,height=2,width=6, command=lambda:btnClick(0))
...
btn_divid=Button(root,text="/",font="ariel 12 bold",bd=12,height=2,width=6, command=lambda:btnClick('/'))
